          ...
          <script type="text/javascript">
              $(function() {
                  ...
                  var table = $('.data-table').DataTable({
                      processing: true,
                      serverSide: true,
                      ajax: "{{ route('leadactivitytype.index') }}",
                      columns: [{
                              data: 'DT_RowIndex',
                              name: 'DT_RowIndex'
                          },
                  ...
                  // Event delegation to handle click event on toggle buttons
                    ...
                    //     $.ajax({
                    //         type: 'POST',
                    //         url: "{{ route('leadactivitytype.updateStatus') }}", // Replace 'updateStatus' with your actual route name
                    ...
                    $(document).on('change', '.status-toggle', function() {
                        ...
                        $.ajax({
                            type: 'POST',
                            url: "{{ route('leadactivitytype.updateStatus') }}",
                            data: { id: id, status: status },
                            success: function(response) {
                  ...
                  $('body').on('click', '.editLead', function() {
                      ...
                      $.get("{{ route('leadactivitytype.index') }}" + '/' + product_id + '/edit', function(data) {
                          $('#modelHeading').html(
                ...
                //       $.ajax({
                //           type: 'POST',
                //           url: "{{ route('leadactivitytype.store') }}",
                //           data: formData,
                //           contentType: false,
                //           processData: false,
                //           success: (response) => {
                ...
                //   });
                  ...
                  $('body').on('click', '.deleteLead', function() {
                      ...
                      $.ajax({
                          type: "DELETE",
                          url: "{{ route('leadactivitytype.store') }}" + '/' + product_id,
