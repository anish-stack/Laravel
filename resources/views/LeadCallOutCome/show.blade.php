 <div class="col-md-6">
     <div class="card mt-5">
         <h2 class="card-header"><i class="fa-regular fa-credit-card"></i> Table</h2>
         <div class="card-body">
              ...
              $(function() {
                  ...
                  // Event delegation to handle click event on toggle buttons
                    ...
                    $(document).on('change', '.status-toggle', function() {
                        ...
                        $.ajax({
                            type: 'POST',
                            url: "{{ route('leadcall.updateStatus') }}",
                            data: { id: id, status: status },
                            success: function(response) {
                  ...
                  $('body').on('click', '.editLead', function() {
                      ...
                      $.get("{{ route('leadcall.index') }}" + '/' + product_id + '/edit', function(data) {
                          $('#modelHeading').html(
                ...
                //   });
                  ...
                  $('body').on('click', '.deleteLead', function() {
                      ...
                      $.ajax({
                          type: "DELETE",
                          url: "{{ route('leadcall.store') }}" + '/' + product_id,
