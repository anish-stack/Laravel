 <div class="col-md-6">
     <div class="card mt-5">
         <h2 class="card-header"><i class="fa-regular fa-credit-card"></i> Lead Type</h2>
         <div class="card-body">
          ...
          <script type="text/javascript">
              $(function() {
                  ...
                  // Event delegation to handle click event on toggle buttons
                    ...
                    //     $.ajax({
                    //         type: 'POST',
                    //         url: "{{ route('leadtype.updateStatus') }}", // Replace 'updateStatus' with your actual route name
                    ...
                    $(document).on('change', '.status-toggle', function() {
                        ...
                        $.ajax({
                            type: 'POST',
                            url: "{{ route('leadtype.updateStatus') }}",
                            data: { id: id, status: status },
                            success: function(response) {
                  ...
                  $('body').on('click', '.editLead', function() {
                      ...
                      $.get("{{ route('leadtype.index') }}" + '/' + product_id + '/edit', function(data) {
                          $('#modelHeading').html(
                          "<i class='fa-regular fa-pen-to-square'></i> Edit Lead");
                          $('#saveBtn').val("edit-user");                       
                          $('#product_id').val(data.lt_id);
                ...
                //   });
                  ...
                  $('body').on('click', '.deleteLead', function() {
                      ...
                      $.ajax({
                          type: "DELETE",
                          url: "{{ route('leadtype.store') }}" + '/' + product_id,
