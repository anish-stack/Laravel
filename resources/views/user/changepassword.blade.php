                    ...
                    <div class="flex-row-auto offcanvas-mobile w-250px w-xxl-350px" id="kt_profile_aside">
                        ...
                        <div class="card card-custom card-stretch">
                                    ...
                                    <div
                                        ...
                                        @if (Auth::user()->userimage)
                                            <div class="symbol-label"
                                                style="background-image:url('{{ asset('storage/profile/' . Auth::user()->userimage) }}')">
                                            @else
                                                <div class="symbol-label"
                                                    style="background-image:url('{{ asset('default_img/profile_photo_1714818371.jpg') }}')">
                                        @endif
                            ...
                            <div class="navi navi-bold navi-hover navi-active navi-link-rounded">
                                ...
                                <div class="navi-item mb-2">
                                    <a href="{{ route('changepasswordpage') }}" class="navi-link py-4 active">
                                        <span class="navi-icon mr-2">
                                            <span class="svg-icon">
                ...
                <div class="flex-row-fluid ml-lg-8">
                    ...
                    <div class="card card-custom">
                        ...
                        <div class="card-header py-3">
                            ...
                            <form class="form" action="{{ route('passwordchange') }}" method="POST"
                        ...
                        <div class="card-body">
                            ...
                            <div  id="error_message" class="alert alert-custom alert-light-danger fade show mb-10" style="display:none;" role="alert">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9 col-xl-6">
                                    <input type="password" class="form-control form-control-lg form-control-solid"
                                        value="" name="password" id="password" placeholder="New password" />
                                </div>
                            </div>
                            <div class="form-group row">
