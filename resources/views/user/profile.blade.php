                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-xl-6">
                                            <div class="image-input image-input-outline" id="kt_profile_avatar"
                                                ...
                                                @if (Auth::user()->userimage)
                                                    <div class="image-input-wrapper" style="background-image:url('{{ asset('storage/profile/'.Auth::user()->userimage)}}')">
                                                @else
                                                    <div class="image-input-wrapper" style="background-image:url('{{ asset('default_img/profile_photo_1714818371.jpg')}}')">
                                                @endif
