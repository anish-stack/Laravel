...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/logo', [ProfileController::class, 'logo'])->name('logo');
    ...
    Route::post('/ownprofile_change', [ProfileController::class, 'ownprofile_change'])->name('ownprofile_change');
    ...
    // lead assign
    Route::resource('leadassign', LeadAssignController::class);
    Route::post('leadassign/update', [LeadAssignController::class, 'assignLead'])->name('assignLead.assignLead');
